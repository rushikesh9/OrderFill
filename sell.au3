...
if $ordertype == "Market Order" Then
   ...
   ControlCommand("Sell Order","","ComboBox1","SelectString",$segment)  ; Select Exchange
   ControlCommand("Sell Order","","ComboBox3","SelectString","MARKET")  ; Select Market
   ControlCommand("Sell Order","","ComboBox5","SelectString",$Inst) ; Select instrument
   ControlCommand("Sell Order","","ComboBox6","SelectString",$symbol) ;Select symbol
   ControlCommand("Sell Order","","ComboBox7","SelectString",$option) ;Select option type ce/pe
   ControlCommand("Sell Order","","ComboBox8","SelectString",$strike) ;Select option strike
   ControlCommand("Sell Order","","ComboBox9","SelectString",$expiry) ;Select option strike
...
ElseIf $ordertype == "Bracket Order" Then
   ...
   ControlCommand("Sell Bracket","",2636,"SelectString",$expiry) ;Select option strike
...
Else
	...
	ControlCommand("Sell Cover","","ComboBox1","SelectString",$segment)  ; Select Exchange
	ControlCommand("Sell Cover","","ComboBox4","SelectString",$Inst) ; Select instrument
	ControlCommand("Sell Cover","","ComboBox5","SelectString",$symbol) ;Select symbol
	ControlCommand("Sell Cover","","ComboBox6","SelectString",$option) ;Select option type ce/pe
	ControlCommand("Sell Cover","","ComboBox7","SelectString",$strike) ;Select option strike
	ControlCommand("Sell Cover","","ComboBox8","SelectString",$expiry) ;Select option strike
